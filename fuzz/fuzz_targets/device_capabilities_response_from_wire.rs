...
// $ util/new_protocol_target.py --target-templates from_wire -- capabilities::DeviceCapabilitiesResponse
...
fuzz_target!(|data: &[u8]| {
    ...
    let mut data = data;
    let _ = DeviceCapabilitiesResponse::from_wire(&mut data, &arena);
});
