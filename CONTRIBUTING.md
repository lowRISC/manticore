# Contributing code to the manticore repository

## Contributor License Agreement

Contributions to Manticore must be accompanied by sign-off text that indicates
